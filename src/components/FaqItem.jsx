  ...
  return (
    <div className="relative z-2 mb-16">
      <div className="group relative flex cursor-pointer items-center justify-between gap-10 px-7"
        onClick={()=>{
        //This status for all property will change in question
        // eslint-disable-next-line react/prop-types
        ...
        {/* button  faq-icon-> has before and  after and we use animation to change property*/}
        <div className={clsx('faq-icon relative flex size-12 items-center justify-center rounded-full border-2 border-s2 shadow-400 transition-all duration-500 group-hover:border-s4', active && 'bg-p1 after:rotate-0 after:bg-p1')}>
